...
background-image: url("atlantic class politics.png")
background-size: contain

---

background-image: url("jacobin dealignment.png")
background-size: contain

---

background-image: url("hierarchy cartoon.png")
background-size: contain

---

background-image: url("hierarchy kansas.jpg")
background-size: contain
...
background-image: url("atlantic tightwads.png")
background-size: 80%
...
background-image: url("LISS BDCM results.jpeg")
background-size: contain
...
background-image: url("figure liss did.png")
background-size: contain

---

background-image: url("figure taps did.png")
background-size: contain
